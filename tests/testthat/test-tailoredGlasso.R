...
test_that("tailoredGlasso returns objects of correct classes", {
...
test_that("tailoredGlasso throws error", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
...
test_that("tailoredGlasso default arguments", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
...
test_that("tailoredGlasso works given all parameters", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
...
test_that("tailoredGlasso arguments control what they should", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
...
test_that("tailoredGlasso results are valid", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
...
test_that("tailoredGlasso results have correct lengths", {
  # Example: Highly informative prior.
  set.seed(123)
  n <- 30
  p <- 5
